	...
	<div class="web_container1">
		<div class="tab_cont">
			<div class="faq_category">
				...
				<label class="switch01">
					<input type="radio" name="faqcategory" onclick="location.href='faqListForm.do?fnum=3'">
					<span>딜리버리 주문</span>
				</label>
				<label class="switch01">
				...
				<label class="switch01">
					<input type="radio" name="faqcategory" onclick="location.href='faqListForm.do?fnum=5'">
					<span>버거킹카드</span>
				</label>
				<label class="switch01">
					<input type="radio" name="faqcategory" checked="checked" onclick="location.href='faqListForm.do?fnum=6'">
					<span>기타</span>
				</label>
			</div>
