...
<article>
	...
	<div class="subtitWrap">
		...
		<ul id="terms_wrap_ul" style="right: 0; top:0">
			<li>
				<span>
					<a href="MfaqList1.do" style="color: red; text-decoration: underline;">FAQ</a>
				</span>
			</li>
			<li><span><a href="MqnaForm.do">문의</a></span></li>
		...
		<div class="tab_cont">
			<div class="faq_category">
				<label class="switch01">
					<input type="radio" name="faqcategory" onclick="location.href='MfaqListForm.do?fnum=1'">
					<span>전체</span>
				</label>
				<label class="switch01">
					<input type="radio" name="faqcategory" onclick="location.href='MfaqListForm.do?fnum=2'">
					<span>제품/품질/서비스</span>
				</label>
				<label class="switch01">
					<input type="radio" name="faqcategory" onclick="location.href='MfaqListForm.do?fnum=3'">
					<span>딜리버리 주문</span>
				</label>
				<label class="switch01">
					<input type="radio"	 name="faqcategory" checked="checked"onclick="location.href='MfaqListForm.do?fnum=4'">
					<span>임대 / 가맹</span>
				</label>
				<label class="switch01">
					<input type="radio" name="faqcategory" onclick="location.href='MfaqListForm.do?fnum=5'">
					<span>버거킹카드</span>
				</label>
				<label class="switch01">
					<input type="radio" name="faqcategory" onclick="location.href='MfaqListForm.do?fnum=6'">
					<span>기타</span>
				</label>
			</div>
