	...
	<div class="web_container1">
		<div class="tab_cont">
			<div class="faq_category">
				...
				<label class="switch01">
					<input type="radio"	 name="faqcategory" onclick="location.href='MfaqListForm.do?fnum=4'">
					<span>임대 / 가맹</span>
				</label>
				<label class="switch01">
				...
				<label class="switch01">
					<input type="radio" name="faqcategory" checked="checked" onclick="location.href='MfaqListForm.do?fnum=6'">
					<span>기타</span>
				</label>
			</div>
