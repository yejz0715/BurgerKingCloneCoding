...
<div class="clear"></div>
<form name="order" method="post" action="Mburger.do" style="background: #f2ebe6;">
		...
		<div class="totamountWrap">
			<div class="c_btn m_item2">
				<c:if test="${!empty loginUser}">
					<button type="button" class="btn01 m red" onclick="location.href='MdeliveryForm.do?kind1=1'">
